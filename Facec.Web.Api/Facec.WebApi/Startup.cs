...
namespace Facec.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddAspNetCore().AddControllerActivation().AddViewComponentActivation().AddPageModelActivation().AddTagHelperActivation();
            ...
            services.AddDbContext<DataBaseContext>(options => options.UseMySQL(_mySqlConnection), ServiceLifetime.Singleton);
