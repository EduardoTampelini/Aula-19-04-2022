...
namespace Facec.Repositorio.nsClasses
{
    public class ClienteRepositorio : IClienteRepositorio
    {
        ...
        public void Excluir(Cliente cliente) => Clientes.Remove(cliente);

        public void Gravar(Cliente cliente) => Clientes.Add(cliente);

        public IEnumerable<Cliente> Obter() => Clientes.AsEnumerable();
    }
}
